...
export const icons ={
    ...
    trash:          <i className="fa-regular fa-trash-alt"></i>,
    gift:           <i className="fa-solid fa-gift"></i>,
    investment:     <i className="fa-solid fa-chart-simple"></i>,
    trade:          <i className="fa-solid fa-money-bill-trend-up"></i>,
